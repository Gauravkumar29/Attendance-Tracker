              ...
              public void onClick(View v) {
                  if(currdate.equals("nothing"))
                      ...
                      if (ckeckforlefthour()) {
                          ...
                          StyleableToast.makeText(Attendance.this, "Your total course hour are finish", R.style.exampleToast).show();
                      }
                  }
              }
          });
        ...
        if(mydb.checkattendance(mark_subject,mark_date)){
             if(mydb.checkleave(mark_subject,mark_date)){
                 if(check()){
                     ...
                     StyleableToast.makeText(Attendance.this, "You cann't take more than 8 leave", R.style.exampleToast).show();
                 }
             }else{
